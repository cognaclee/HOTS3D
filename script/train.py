...
def parse_args_and_logger():
    ...
    #data parameter
    parser.add_argument('--text_dir',type=str,default='./datasets/text2shape/train/text', help='directory of text features')
    parser.add_argument('--img_dir',type=str,default='./datasets/text2shape/train/image', help='directory of image features')
