...
if __name__ == '__main__':
    ...
    '''
    #text_file = '/home/lwh/code/shap-e/clip_forge_text.txt'
    #text_file = '/home/lwh/code/shap-e/PureCLIPNeRF_Text_Name200.txt'
    #text_file = './3DFuse_result_text.txt'  文本路径换掉
    ...
    #text_file = '/home/lwh/code/shap-e/clip_forge_PNG_name.txt'# shape
    # text_file = '/home/lwh/code/SDFusion/result/name.txt'# SDFusion
    # text_file = '/home/lwh/code/TAPS3D-main/name.txt' #TAPS3D
    
    #text_file = '/home/lwh/code/shap-e/PureCLIPNeRF_PNG_Name200.txt' #cvx0_invx1
    '''
    img_list = []
    with open(text_file, 'r') as f:
        for line in f.readlines():
    ...
    #image_dir = '/mnt/data2/results/SDFusion2png/'
    image_dir = '/mnt/data2/results/xcube_SOT2png/'
    img_list = []
    for idx in orders:
    ...
    for i in range(0,data_len,batch_size):
        ...
        with torch.no_grad():
            ...
            #print('clip_prediction.shape=',clip_prediction.shape)
    ...
    #"""
#nohup python clip_r_precision.py > ln3diff_32.file 2>&1 &  
