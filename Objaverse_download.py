...
if __name__ == "__main__":
    ...
    # Use all the 'object_paths' comme UIDs
    uids = list(object_paths.keys())[:200]
    
    # Charge all the annotations UIDs
    load_annotations(uids)
    print(f"Loaded annotations for {len(uids)} uids")
    
    # Download all the objects with these UIDs
...
__version__ = "1.0"
_VERSIONED_PATH = os.path.join("./objaverse", "hf-objaverse-v1")
